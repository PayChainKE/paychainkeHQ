...
export const REVENUE_STREAMS = [
  ...
  },
  {
    ...
    description: 'NCBA\'s replacement for Daraja B2C — merchant withdrawals to M-Pesa/Airtel numbers via NCBA\'s Mobile B2W Payment API, once NCBA_STK_B2C_ENABLED is on. NCBA has not published a real cost schedule for this rail; the numbers here are inherited from Safaricom\'s own B2C tariff (getB2cTariff) as a placeholder, not a claim about NCBA\'s actual cost.',
    icon: 'smartphone',
    accent: 'rose',
    tiered: true,
    rate: null,
