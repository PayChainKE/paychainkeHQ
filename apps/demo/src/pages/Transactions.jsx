...
export default function Transactions() {
  ...
  const handleExport = () => {
    ...
    doc.setFontSize(10)
    doc.setFont('helvetica', 'normal')
    const narrative = `This document serves as the official transaction summary for Virtual Account 84729. It provides a comprehensive record of all financial movements, including inbound payments, outbound settlements, and currency swaps. These records are cryptographically verified and stored on the PayChainKE immutable ledger for your business security.`
    ...
    <MerchantLayout title="Transactions">
      <div className="px-1 lg:px-0 max-w-7xl mx-auto w-full">
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p className="text-on-surface-variant text-[11px] lg:text-sm font-medium mt-1.5 opacity-80">All verified inbound payments to Virtual Account 84729</p>
        </div>
