...
const ITEMS: Item[] = [
  ...
  { icon: Users2, title: "Payroll and supplier payments", who: "Employers, agencies, farms, logistics", how: "Pay a whole batch of wallets, banks and Paybills in one call, with tax deductions for employees.", use: "Bulk payments", to: "/bulk-payments", toLabel: "Bulk payments" },
