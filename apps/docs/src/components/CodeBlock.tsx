...
export default function CodeBlock({ code, lang = "text", label, className }: CodeBlockProps) {
  ...
  return (
    <div className={cn("group relative rounded-xl border border-border bg-surface overflow-hidden", className)}>
      <div className="flex items-center justify-between px-4 py-2 border-b border-border-subtle bg-surface-raised/60">
