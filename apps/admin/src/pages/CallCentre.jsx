    ...
    <div className="flex items-start gap-4">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-on-surface-variant/70 mb-3 max-w-2xl">
          Records will show up here automatically once a provider webhook is wired. Africa's Talking and Twilio integration is planned but not yet implemented — no webhook endpoint exists on the backend yet.
        </p>
