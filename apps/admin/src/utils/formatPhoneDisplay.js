...
// (paybill numbers, virtual account numbers, "MASTER_WALLET", Stellar public
// keys, etc.) passes through unchanged, so this is always safe to wrap
// around a sender/recipient id without special-casing non-phone values.
