...
export default function SupportTab() {
  ...
  const faqs = [
    ...
    { q: 'What is Trust Score, and how do I qualify for a Cash Advance?', a: 'Trust Score reflects your transaction history and account activity on PayChain — the more you process, the higher it climbs. Once it reaches 60, you become eligible to apply for a Cash Advance against your future revenue.' },
    ...
    { q: 'Is my data secure?', a: 'Yes. We use bank-level encryption, your password and PIN are hashed and never stored in plain text, and Digital Wallet transactions are additionally verified on the Stellar blockchain.' },
    ...
    <ScrollView className="flex-1" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
      <View className="w-full max-w-lg mx-auto px-6 pt-2 pb-12">
        ...
        <View className="items-center py-6 mb-2">
          ...
          <Text className="text-[#707971] text-[14px] font-jakarta-medium mb-8 text-center leading-relaxed opacity-90 px-4">
            ...
            {solutions.map((s, i) => (
              ...
              >
                <View className="p-5 border border-black/5" style={{ backgroundColor: s.color, height: 160 }}>
                  ...
                  <Text className="text-[11px] text-[#00351d]/60 font-jakarta-medium leading-tight">{s.desc}</Text>
                </View>
              </TouchableOpacity>
            ))}
          </View>
              ...
              >
                ...
                {expandedFaq === i && (
                  <View className="px-5 pb-5 pt-0">
                    <Text className="text-[13px] text-[#707971] leading-relaxed font-jakarta-medium">{f.a}</Text>
                  </View>
                )}
              </TouchableOpacity>
            ))}
