        ...
        <View className="w-full max-w-lg mx-auto px-6 pt-6">
          ...
          {step === 1 && (
            <View className="gap-3">
                ...
                >
                  <View className="flex-row items-center justify-between mb-4">
                    ...
                    <View className="bg-[#f7faf7] px-3 py-1.5 rounded-full">
                      <Text className="text-[10px] font-jakarta-extrabold uppercase tracking-[0.15em] text-[#5b645c]">{opt.tag}</Text>
                    </View>
                  </View>
                  <Text style={{ fontFamily: 'DMSerifDisplay_400Regular' }} className="text-[20px] text-[#00351d] mb-1.5">{opt.title}</Text>
                  <Text className="text-[12px] text-[#5b645c] font-jakarta-bold leading-relaxed">{opt.description}</Text>
                </TouchableOpacity>
              ))}
              ...
              <View className="bg-[#00351d] rounded-[28px] p-6 mt-3">
                ...
                <Text style={{ fontFamily: 'DMSerifDisplay_400Regular' }} className="text-[20px] text-white mb-1">Integrate our Request API</Text>
          ...
          {step === 2 && selected && isSubmitting && selected.id === 'mpesa' ? (
            <View className="items-center pt-4">
              ...
              <Text className="text-[13px] text-[#5b645c] font-jakarta-bold text-center leading-relaxed px-4 mb-8">
              ...
              {feePreview && (
                <View className="mb-5 px-1">
                  <View className="flex-row justify-between">
                    <Text className="text-[12px] text-[#5b645c] font-jakarta-bold">They'll be asked to pay</Text>
                    <Text className="text-[12px] font-jakarta-extrabold text-[#00351d]">{formatKES(feePreview.total)}</Text>
                  </View>
                  {feePreview.fee > 0 && (
                    <Text className="text-[10px] text-[#5b645c] font-jakarta-bold opacity-70 mt-0.5">
            ...
            <View className="items-center pt-4">
              ...
              {selected.id === 'mpesa' ? (
                ...
                <>
                  ...
                  <Text className="text-[13px] text-[#5b645c] font-jakarta-bold text-center leading-relaxed px-4 mb-5">
          ...
          >
            {isSubmitting ? (
              <>
                ...
                <Text className="text-[#5b645c] font-jakarta-extrabold text-[12px] uppercase tracking-widest">{statusText || 'Processing...'}</Text>
              </>
            ) : (
