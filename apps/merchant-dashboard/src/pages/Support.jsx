...
export default function Support() {
  ...
  const faqs = [
    ...
    { q: 'What is my PayChain Virtual Account?', a: 'It\'s the dedicated NCBA account number tied to your business, shown on your Overview page. Anyone can pay into it directly by bank transfer or M-PESA, and it settles straight into your PayChain balance.' },
    ...
    { q: 'Is my data secure?', a: 'Yes. We use bank-level encryption, and Digital Wallet transactions are additionally verified on the Stellar blockchain, so your money and your data stay protected.' },
