    ...
    <MerchantLayout title="Notifications">
      <div className="max-w-4xl mx-auto px-4 lg:px-0 py-6 lg:py-10 animate-fade-in-up">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 lg:mb-12">
          <div>
            <h2 className="text-3xl lg:text-5xl font-headline tracking-tight text-primary">Alert Center</h2>
          ...
          <button 
            ...
            className="px-5 py-2.5 bg-emerald-50 text-emerald-700 text-sm font-black rounded-xl hover:bg-emerald-100 transition-all flex items-center gap-2 border border-emerald-500/10 active:scale-95"
          >
