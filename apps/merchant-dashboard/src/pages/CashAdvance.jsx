    ...
    <MerchantLayout title="Cash Advance">
      <div className="px-1 lg:px-0 max-w-4xl mx-auto w-full space-y-8 lg:space-y-12">
        ...
        <div className="mb-6 lg:mb-10">
          <h2 className="font-headline text-3xl lg:text-4xl text-primary tracking-tight leading-tight">Cash Advance</h2>
          ...
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-12">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-headline text-2xl text-white">Active Advance</h3>
              ...
              <div className="text-right">
                ...
                <p className={`font-headline text-2xl lg:text-3xl tracking-tight transition-all duration-300 ${!showAmounts && 'blur-md'}`}>{formatKES(adv.amount)}</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-8">
          <section className="bg-white p-8 rounded-[32px] border border-[#E5E7EB] shadow-sm editorial-shadow">
            <h3 className="font-headline text-xl text-primary mb-6">Terms & Disclosure</h3>
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex justify-between items-start py-4 border-b border-slate-50 last:border-0">
                  <div>
                    <p className="text-sm font-bold text-primary">{term.label}</p>
                    <p className="text-[11px] text-on-surface-variant opacity-60">{term.desc}</p>
                  </div>
